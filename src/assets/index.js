export const appIcons = {
  ...
  personIcon: require('../assets/images/person1.jpg'),
...
export const appImages = {
  ...
  jacketBlack: require('../assets/images/jacketblack.png'),
  ...
  jacketSkin: require('../assets/images/jecketskin.png'),
  Tshirt: require('../assets/images/Tshiet.png'),
  TshirtBlack: require('../assets/images/TshietBlack.png'),
  TshirtRed: require('../assets/images/Tshietred.png'),
